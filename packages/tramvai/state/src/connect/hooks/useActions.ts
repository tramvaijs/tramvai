...
export function useActions<const A extends Readonly<TramvaiAction<any, any, any>[]>>(
  actions: A
): {
...
export function useActions<const P extends any[], R, Deps = any>(
  action: TramvaiAction<P, R, Deps>
): (...args: P) => Promise<R extends Promise<infer U> ? U : R>;
export function useActions<const A extends TramvaiAction<any, any, any>[]>(
  actions: A
): {
  [key in keyof A]: (...args: any[]) => Promise<any>;
};
export function useActions<const A extends Readonly<Action<any, any>[]>>(
  actions: A
): {
...
export function useActions<const P, R>(
  action: Action<P, R>
): (payload?: P) => Promise<R extends PromiseLike<infer U> ? U : R>;
export function useActions<const A extends Action<any, any>[]>(
  actions: A
): {
