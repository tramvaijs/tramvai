...
export const ReactComponent = () => {
  return React.createElement('div', { className: 'react' },
...
export const OtherLibraryComponent = () => {
  return createElement('div', { className: 'other' },
...
export const Parse5Component = () => {
  // @ts-ignore
  return Parse5.createElement('div', { className: 'parse5' },
    // @ts-ignore
...
export const OtherLibraryDefaultExportComponent = () => {
  return OtherLibraryDefaultExport.createElement('div', { className: 'OtherLibraryDefaultExport' },
