export const SSRDocumentContentMocks = {
  ...
  <head>
    ...
    <script async data-chunk="rootErrorBoundary" src="\${STATIC_URL}/dist/client/runtime.js"></script>
    <script async data-chunk="rootErrorBoundary" src="\${STATIC_URL}/dist/client/react.js"></script>
    <script async data-chunk="rootErrorBoundary" src="\${STATIC_URL}/dist/client/tramvai.js"></script>
