...
export const testCasesConditions: Record<string, TestCase> = {
  ...
  'latest-v3.0.1': {
    ...
    reactQuery: {
      ...
      scriptsCount: 7, // except runtime and main entry chunks, shared chunks @tramvai/core and @tramvai/react should be loaded, because we can't share different major versions (v3 and v4), while others should be shared
    },
  },
};
